...
class Agent():
    ...
    def __init__(self, state_size, action_size, random_seed):
        ...
        self.actor_local = Actor(state_size, action_size, random_seed, fc1_units=ACTOR_FC1_UNITS, fc2_units=ACTOR_FC2_UNITS).to(device)
        self.actor_target = Actor(state_size, action_size, random_seed, fc1_units=ACTOR_FC1_UNITS, fc2_units=ACTOR_FC2_UNITS).to(device)
        self.actor_optimizer = optim.Adam(self.actor_local.parameters(), lr=LR_ACTOR)

        # Critic Network (w/ Target Network)
        self.critic_local = Critic(state_size, action_size, random_seed, fcs1_units=CRITIC_FCS1_UNITS, fc2_units=CRITIC_FC2_UNITS).to(device)
        self.critic_target = Critic(state_size, action_size, random_seed, fcs1_units=CRITIC_FCS1_UNITS, fc2_units=CRITIC_FC2_UNITS).to(device)
