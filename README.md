...
In this repo I work with the [Tennis](https://github.com/Unity-Technologies/ml-agents/blob/master/docs/Learning-Environment-Examples.md#tennis) environment.
...
3. Place the file in the MARL GitHub repository folder, and unzip (or decompress) the file. 

4. Start docker by running the command: `./start_docker`

5. Make sure conda environment `rl` is activated.

6. Install missing dependencies by running `./env_setup.sh`.
...
- Learning passes every update is 10 times.
- Number of Agents: 2
...
### (To Do) Soccer Environment

The **Soccer** environment is more challenging.
...
Then, place the file in the repo folder, and unzip (or decompress) the file.  Next, open `Soccer.ipynb` and follow the instructions to learn how to use the Python API to control the agent.
